      ...
      <div className={profileTheme.section}>
        ...
        {!isSignedInWithGoogle && !firebaseUser && !showEmailForm && (
          <div className="space-y-4 mb-6">
            <button
              ...
              disabled={busy}
              className="w-full flex items-center justify-center gap-3 rounded-md border border-slate-300 bg-white px-4 py-3 text-sm font-medium text-slate-700 shadow-sm hover:bg-slate-50 disabled:opacity-50 transition-colors"
            >
        ...
        {(isSignedInWithGoogle || firebaseUser || showEmailForm) && (
          <div className="space-y-6">
            ...
            <section>
              <div className={profileTheme.sectionTitle}>{t.personalInfo}</div>
                  ...
                  <Field label={t.email} error={touched.email ? requiredErrors.email : null}>
                    <div className="relative">
                      ...
                      {isSignedInWithGoogle && (
                        <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2 text-xs text-slate-500 bg-white px-2">
                  ...
                  <Field label={t.phone} error={touched.phone ? requiredErrors.phone : null}>
                    <div className="flex gap-2">
                      <select
                        ...
                        className={`${profileTheme.input} w-20 flex-shrink-0 text-xs`}
                      >
            ...
            {/* Gender Section */}
            <section>
              <div className={profileTheme.sectionTitle}>{t.gender}</div>
              <RadioGroup
                value={gender}
                onChange={setGender}
                options={[
            ...
            <section>
              <div className={profileTheme.sectionTitle}>{t.preferredLanguage}</div>
              <div className={profileTheme.grid}>
                <div className="sm:col-span-2">
                  <Field
            ...
            {/* Address Section */}
            <section>
              <div className={profileTheme.sectionTitle}>{t.address}</div>
              <div className={profileTheme.grid}>
