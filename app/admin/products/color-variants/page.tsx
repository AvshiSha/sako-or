              ...
              <div key={product.id} className="bg-white shadow rounded-lg">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Base SKU: {product.baseSku} • {Object.keys(product.colorVariants).length} color variants
                      </p>
                    </div>
                ...
                <div className="px-6 py-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {Object.entries(product.colorVariants).map(([colorKey, variant]) => (
                      <div key={colorKey} className="border border-gray-200 rounded-lg p-4">
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center space-x-2">
                            ...
                            />
                            <h4 className="font-medium text-gray-900">{variant.colorSlug}</h4>
                          </div>
                        ...
                        <div className="space-y-2 text-sm text-gray-600">
                          ...
                          <div className="flex justify-between">
                            <span>Price:</span>
                            <span>₪{variant.priceOverride || product.price}</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Stock:</span>
                            <span>{Object.values(variant.stockBySize).reduce((sum, stock) => sum + stock, 0)}</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Sizes:</span>
                            <span>{Object.keys(variant.stockBySize).length}</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Images:</span>
                        ...
                        <div className="mt-4 flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <button
                              onClick={() => handleDeleteVariant(colorKey, product.name?.en || 'Unknown')}
