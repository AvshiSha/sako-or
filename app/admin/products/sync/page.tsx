  ...
  const syncProducts = async () => {
    try {
      ...
      if (data.success) {
        ...
        setErrors([data.error || 'Failed to sync products'])
      }
    } catch (error) {
      console.error('Error syncing products:', error)
      setErrors(['Failed to sync products'])
    } finally {
      setLoading(false)
    }
  }
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center">
              ...
              <h1 className="text-3xl font-bold text-gray-900">Sync Products</h1>
            </div>
            <p className="text-gray-600 mt-2">Synchronize products between Firebase and Neon DB</p>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-blue-700 mb-4">
                  Your application uses two databases for products:
                </p>
                <ul className="list-disc list-inside text-blue-700 space-y-1 mb-4">
                  <li><strong>Firebase:</strong> Primary database for products (used by the website)</li>
          ...
          <div className="bg-white shadow rounded-lg p-6">
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                Follow these steps to synchronize your products:
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Compare products between Firebase and Neon DB</p>
                </div>
                <button
              ...
              {comparisonData && (
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                  <div>
                    <h3 className="font-medium text-gray-900">Step 2: Sync Products</h3>
                    <p className="text-sm text-gray-600">
                      {comparisonData.differences.needsSync 
                        ? `Found ${comparisonData.differences.missingInNeon.length} products to sync`
                        : 'Products are already in sync'
                      }
                    </p>
                  </div>
                  <button
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mb-2">
                        {comparisonData.firebase.count} products
                      </p>
                      <div className="max-h-32 overflow-y-auto">
                        {comparisonData.firebase.products.map((sku, index) => (
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mb-2">
                        {comparisonData.neon.count} products
                      </p>
                      <div className="max-h-32 overflow-y-auto">
                        {comparisonData.neon.products.map((sku, index) => (
                          <div key={index} className="text-sm text-gray-700 py-1">
                            • {sku}
                          </div>
                        ))}
                  ...
                  {comparisonData.differences.missingInNeon.length > 0 && (
                    <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                      ...
                      <div className="text-sm text-yellow-700">
                        {comparisonData.differences.missingInNeon.map((sku, index) => (
                  ...
                  {comparisonData.differences.extraInNeon.length > 0 && (
                    <div className="mt-4 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                      ...
                      <div className="text-sm text-orange-700">
                        {comparisonData.differences.extraInNeon.map((sku, index) => (
                          <div key={index}>• {sku}</div>
                        ))}
                      </div>
                    </div>
