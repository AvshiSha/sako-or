                    ...
                    <div>
                      ...
                      {(item.size || item.sku || item.colorName) && (
                        <div style={{ fontSize: '12px', color: '#666', marginTop: '2px' }}>
                          ...
                          {item.colorName && (
                            <span>{t.colorLabel}: {getColorName(item.colorName, 'he')}</span>
                          )}
                        </div>
                      )}
                    </div>
   ...
   items: [
     {
       ...
       productUrl: 'https://sako-or.com/he/product/0000-0000/black',
     },
     {
       name: 'ג׳קט אלגנטי',
       quantity: 2,
       ...
       colorName: 'white',
       imageUrl: 'https://firebasestorage.googleapis.com/v0/b/sako-or.firebasestorage.app/o/images%2Fplaceholder.svg?alt=media&token=fe297841-0047-47c2-9523-823e98cd6e8f',
       productUrl: 'https://sako-or.com/he/product/0000-0001/white',
     },
   ],
   total: 330.99,
   subtotal: 350.99,
