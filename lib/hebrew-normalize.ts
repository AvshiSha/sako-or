...
const PRODUCT_TYPE_VARIATIONS: Record<string, string[]> = {
  ...
  'תיק': ['תיקים', 'תיקות'],
  'תיקה': ['תיקים', 'תיקות'],
  // Bag types. Customers ask for these by name ("תיק צד", "קלאץ'", "ארנק")
  // rather than by the category name, so each needs to reach the bagType label.
  'תיק צד': ['תיקי צד', 'קרוסבודי', 'תיק'],
  'תיקי צד': ['תיק צד', 'קרוסבודי'],
  'קרוסבודי': ['תיק צד', 'תיקי צד'],
  'תיק כתף': ['תיקי כתף', 'תיק'],
  'תיקי כתף': ['תיק כתף'],
  'תיק יד': ['תיקי יד', 'תיק'],
  'תיקי יד': ['תיק יד'],
  'תיק גב': ['תיקי גב', 'תרמיל', 'תרמילים'],
  'תיקי גב': ['תיק גב', 'תרמיל'],
  'תרמיל': ['תיק גב', 'תרמילים'],
  'תרמילים': ['תיק גב', 'תרמיל'],
  'תיק טוט': ['תיקי טוט', 'טוט'],
  'טוט': ['תיק טוט', 'תיקי טוט'],
  'קלאץ': ['קלאצים', 'תיק ערב'],
  'תיק ערב': ['תיקי ערב', 'קלאץ'],
  'תיקי ערב': ['תיק ערב', 'קלאץ'],
  'ארנק': ['ארנקים', 'ארנקה'],
  'ארנקים': ['ארנק'],
  'תיק נסיעות': ['תיקי נסיעות', 'תיק'],
  'תיק מחשב': ['תיקי מחשב', 'תיק לפטופ'],
  'תיק חוף': ['תיקי חוף'],
  'מעילים': ['מעיל', 'מעילה'],
  'מעיל': ['מעילים', 'מעילות'],
  'מעילה': ['מעילים', 'מעילות'],
